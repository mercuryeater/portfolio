      ...
      <main className="skills">
        ...
        <div className="skills__backEnd">
          ...
          <div>
            ...
            {/* Python */}
            <svg  xmlns="http://www.w3.org/2000/svg"  width="85"   viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-python">
